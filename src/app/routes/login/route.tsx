...
export default function Signup() {
    ...
    return (
        <div className="font-sans flex flex-col items-center">
          ...
          <Form method="post" className="flex flex-col justify-around items-center mt-[5vh] w-[80vw] h-[45vh] sm:w-[50vw] sm:h-[50vh] lg:h-[40vh] rounded-lg border-4 border-accent">
            ...
            <div className="flex flex-col lg:flex-row justify-between w-full p-4 items-center lg:p-4">
              ...
              <div className="w-[40vw] sm:w-[30vw]"> 
                <input
                  ...
                  type="password"
                  required
                  className="w-[40vw] sm:w-[30vw] h-[3vh] sm:h-[5vh] text-[2vh] sm:text-[8vh] rounded-lg border-2 border-accent p-2"
                />
              </div>
            </div>
